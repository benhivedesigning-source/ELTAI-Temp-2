      ...
      <section className="py-32 relative overflow-hidden z-10 bg-black m-4 lg:m-8 rounded-[3rem] shadow-2xl border border-zinc-800">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <motion.p 
            ...
            className="text-lg md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed font-medium text-justify"
          >
          ...
          >
            <span className="text-sm font-bold tracking-widest capitalize" style={gradientText}>To Learn More</span>
            <a 
