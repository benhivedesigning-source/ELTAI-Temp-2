...
const Home = () => {
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-[1800px] mx-auto px-4 lg:px-8 w-full flex-1 flex flex-col justify-center mt-10">
          <div className="max-w-5xl">
            ...
            <motion.div 
              ...
              initial="hidden"
              animate="show"
              className="text-4xl sm:text-5xl md:text-7xl lg:text-[4rem] font-heading font-black leading-none tracking-wide mb-10 [word-spacing:0.15em]"
            >
        ...
        <div className="relative z-20 max-w-[1800px] mx-auto px-4 lg:px-8 w-full mt-16">
          ...
          >
            ...
            <div className="bg-black/40 backdrop-blur-md border border-white/10 p-6 rounded-2xl flex items-start gap-4">
              ...
              <div>
                <p className="text-[10px] text-gray-400 font-bold tracking-wider capitalize mb-1">Dates</p>
            ...
            <div className="bg-black/40 backdrop-blur-md border border-white/10 p-6 rounded-2xl flex items-start gap-4">
              ...
              <div>
                <p className="text-[10px] text-gray-400 font-bold tracking-wider capitalize mb-1">Venue</p>
            ...
            <div className="bg-black/40 backdrop-blur-md border border-white/10 p-6 rounded-2xl flex items-start gap-4">
              ...
              <div>
                <p className="text-[10px] text-gray-400 font-bold tracking-wider capitalize mb-1">Hosted By</p>
      ...
      {/* Marquee Section */}
      <div className="w-full bg-primary border-y-4 border-black overflow-hidden py-1 md:py-2 flex items-center relative z-20">
        <motion.div
        ...
        >
          ...
          {[...Array(10)].map((_, i) => (
            <span key={i} className="text-black font-heading font-black text-xl md:text-2xl tracking-widest capitalize mx-4 flex items-center">
              Conference Pune, Maharashtra <span className="mx-4 text-lg">●</span>
            </span>
          ))}
        </motion.div>
      </div>
      ...
      <section className="py-32 relative z-20 bg-slate-50 text-black overflow-hidden">
        {/* Background Decorative Elements */}
        <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-bl from-[#e76366]/10 to-transparent rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 w-[800px] h-[800px] bg-gradient-to-tr from-[#8355eb]/10 to-transparent rounded-full blur-3xl translate-y-1/3 -translate-x-1/3 pointer-events-none"></div>
        ...
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="relative w-full h-[500px] sm:h-[600px]">
              {/* Image 1 (Left, higher) */}
              <motion.div 
                className="absolute left-0 top-0 w-[65%] h-[80%] rounded-[2.5rem] overflow-hidden shadow-2xl z-10 border border-white/20"
              ...
              {/* Image 2 (Right, lower, overlapping) */}
              <motion.div 
                className="absolute right-0 bottom-0 w-[60%] h-[75%] rounded-[2.5rem] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.3)] z-20 border-[6px] border-white"
                initial={{ opacity: 0, x: 30, y: 30 }}
                whileInView={{ opacity: 1, x: 0, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.2 }}
              >
                <img src="https://www.image2url.com/r2/default/images/1776255681594-dd353048-4946-4080-9434-551c568a817c.webp" alt="Speaker at ELTAI" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-black/5"></div>
              </motion.div>

              {/* Circular "STAY TUNED" Badge */}
              <motion.div 
                className="absolute bottom-[5%] left-[30%] w-32 h-32 bg-white rounded-full shadow-2xl z-30 flex items-center justify-center p-1"
              ...
              >
                <div className="absolute inset-0 animate-[spin_12s_linear_infinite]">
                  <svg viewBox="0 0 100 100" className="w-full h-full text-black capitalize text-[9px] font-black">
                    <path id="stayTunedPath" d="M 50, 50 m -37, 0 a 37,37 0 1,1 74,0 a 37,37 0 1,1 -74,0" fill="none" />
                    <text>
                      <textPath href="#stayTunedPath" startOffset="0%" style={{ letterSpacing: '4.5px' }}>
                        Stay Tuned • Stay Tuned • 
                      </textPath>
                    </text>
                  </svg>
                </div>
                <div className="w-3 h-3 rounded-full bg-[#e76366]" />
              </motion.div>
            </div>

            {/* Right: Text Content */}
            <motion.div 
              className="flex flex-col items-center text-center bg-white p-10 md:p-12 rounded-[2.5rem] shadow-2xl shadow-gray-200/50"
              initial={{ opacity: 0, x: 30 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.3 }}
            >
              <div className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary font-bold text-xs capitalize tracking-widest mb-6">
                About Conference
              </div>
              <h3 className="text-4xl md:text-5xl font-heading font-black text-gray-900 mb-8 tracking-wide capitalize leading-tight [word-spacing:0.1em]">
                ELTAI Annual Conference 2026
              </h3>
              <p className="text-gray-600 text-lg leading-relaxed mb-10 font-medium text-justify ">
      ...
      <div className="relative bg-[#f8fafc]">
        <section className="py-32 relative z-10 overflow-hidden">
          <div className="max-w-[1800px] mx-auto px-4 lg:px-8 relative z-10">
            ...
            >
              <h2 className="text-5xl md:text-6xl font-heading font-black tracking-wide text-black capitalize [word-spacing:0.1em]">
                Organiser & Host
              </h2>
            </motion.div>
        ...
        <div className="max-w-[1000px] mx-auto px-4 lg:px-8">
          ...
          <div className="text-center mb-16">
            <motion.h2 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-4xl md:text-5xl lg:text-6xl font-heading font-black tracking-wide capitalize mb-12 leading-tight [word-spacing:0.1em]"
            >
          ...
          <div className="flex flex-col gap-6"> */}
            ...
            >
              <div className="w-full md:w-[280px] h-[220px] rounded-xl overflow-hidden shrink-0 relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black text-center py-2">
                  <p className="text-primary text-[10px] font-bold tracking-widest capitalize mb-0.5">Speaker</p>
                  <p className="text-white text-sm font-black capitalize">Michael Brown</p>
                </div>
              </div>
              <div className="flex-1 pt-2">
                ...
                <h3 className="text-2xl font-heading font-black text-black mb-4 capitalize">Registration And Welcome Coffe</h3>
            ...
            >
              <div className="w-full md:w-[280px] h-[220px] rounded-xl overflow-hidden shrink-0 relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black text-center py-2">
                  <p className="text-primary text-[10px] font-bold tracking-widest capitalize mb-0.5">Speaker</p>
                  <p className="text-white text-sm font-black capitalize">David Green</p>
                </div>
              </div>
              <div className="flex-1 pt-2">
                <div className="flex flex-wrap items-center gap-6 text-sm font-medium text-gray-600 mb-4">
                ...
                <h3 className="text-2xl font-heading font-black text-black mb-4 capitalize">Gathering, Breakfast, Getting Ready</h3>
                <p className="text-gray-500 text-sm leading-relaxed">
                  A wide range of desktop publishing tools and web design editors now feature dummy text as their primary example content. If you look up 'dummy text', you'll find many sites that are still in the early stages of development.
                </p>
              </div>
            ...
            >
              <div className="w-full md:w-[280px] h-[220px] rounded-xl overflow-hidden shrink-0 relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-black text-center py-2">
                  <p className="text-primary text-[10px] font-bold tracking-widest capitalize mb-0.5">Speaker</p>
                  <p className="text-white text-sm font-black capitalize">Guillermo Rauch</p>
                </div>
              </div>
              <div className="flex-1 pt-2">
                <div className="flex flex-wrap items-center gap-6 text-sm font-medium text-gray-600 mb-4">
                ...
                <h3 className="text-2xl font-heading font-black text-black mb-4 capitalize">Sustainable Design Practices</h3>
                <p className="text-gray-500 text-sm leading-relaxed">
                  A wide range of desktop publishing tools and web design editors now feature dummy text as their primary example content. If you look up 'dummy text', you'll find many sites that are still in the early stages of development.
                </p>
              </div>
      ...
      <section className="relative py-32 bg-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 lg:px-8 text-center flex flex-col items-center">
          ...
          <motion.h2 
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="text-5xl md:text-6xl lg:text-7xl font-heading font-black text-white capitalize leading-[1.1] mb-8 tracking-wide [word-spacing:0.1em]"
          >
      ...
      <section className="py-32 bg-white relative z-20">
        <div className="max-w-[1600px] mx-auto px-4 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-4">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-heading font-black tracking-wide text-black capitalize [word-spacing:0.1em]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6"> */}
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="md:col-span-2 md:row-span-2 rounded-3xl overflow-hidden h-[400px] md:h-auto shadow-sm hover:shadow-xl transition-shadow duration-300"
            >
              <img 
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="rounded-3xl overflow-hidden h-[300px] shadow-sm hover:shadow-xl transition-shadow duration-300 md:col-span-1"
            >
              <img 
            ...
            <motion.div 
              ...
              className="md:col-span-2 rounded-3xl overflow-hidden h-[300px] shadow-sm hover:shadow-xl transition-shadow duration-300"
            >
              <img 
